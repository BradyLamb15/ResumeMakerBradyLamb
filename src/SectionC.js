  ...
  return (
    <div className={classes.root}>
      <Grid container direction="column" justify="flex-start" alignItems="center">
			<Paper className={classes.paper} item xs={12} elevation={3} variant="outlined" sqaure>
        <Grid item xs={12}>
          
            <Typography >Layout Example 3 </Typography>
        ...
        <Grid item xs={6} container justify="flex-start" alignItems="flex-start">
         ...
         ----------------
				...
				<Grid item xs={8} container justify="center" alignItems="flex-start">
         ...
         ----------------
				...
				<Grid xs={8} container justify="center" alignItems="flex-start">
				<Typography variant="h5" color="secondary">
          Education
					</Typography>
        </Grid>
         ...
         ----------------
          ...
          <Grid xs={8} container justify="flex-start" alignItems="flex-start">
            ...
            <Typography colro="Primary" variant="h6" align='left' key={pastJob.companyName.toString()}>
              /{pastJob.companyName}
            </Typography>
